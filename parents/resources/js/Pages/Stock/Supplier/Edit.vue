...
export default {
    ...
    methods: {
        ...
        updateSupplier() {
            this.form.put(route('supplier.update',this.supplier.id), {
                preserveScroll: true,
                onSuccess: () => {
                    this.toast.success("Update supplier successfully");
                },
                onError: () => {
                    this.toast.error("Update supplier Errors");
                },
            });
        },
    }
