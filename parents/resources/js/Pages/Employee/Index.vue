                                ...
                                <tbody>
                                    <tr v-for="(employee,index) in employees" :key="index"
                                        ...
                                        <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="pl-3">
                                                <div class="text-base font-semibold">{{ employee.first_name }}</div>
                                            </div>  
                                        </th>
                                        <td class="px-6 py-4">
                                            {{ employee.last_name }}
                                        ...
                                        <td class="px-6 py-4 flex">
                                            <span>
                                                <Link :href="route('users.edit',employee.id)">
                                                    <PencilIcon class="text-blue-600 w-5 h-5"/>
                                                </Link>
                                            </span>
                                            <span><TrashIcon class="text-rose-500 mx-2 cursor-pointer w-6 h-5" @click="deleteUser(employee.id)"/></span>
                                            <span><EyeIcon class="text-blue-500 mx-1 cursor-pointer w-6 h-5" @click="showUser(employee.id)" /></span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
