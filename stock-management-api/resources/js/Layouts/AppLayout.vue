...
import {Cog8ToothIcon,BugAntIcon } from '@heroicons/vue/24/solid';
    ...
    <div>
        ...
        <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
            ...
            <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
                ...
                <!-- <footer class="p-2 my-6 mx-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
